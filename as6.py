...
class BinaryHeap:
    ...
    def left(self, i: int):
        ...
        # Do not check whether the index is valid or not (larger than the heapsize).
        return 2 * i + 1
    ...
    def add(self, item):
        ...
        self.heapsize += 1
        self.increase(self.heapsize - 1, item)
...
for i in range(1, 11):
    bh1.add(i)
print("We start with an empty BinaryHeap bh1, then add numbers 1 ~ 10 to bh1. We have bh1 =", bh1, ".")
